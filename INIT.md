# Kheti AI - Project Initialization

> **Canonical source.** This file is copied to IDE-specific locations so AI assistants auto-load project context:
> - `CLAUDE.md` — Claude Code
> - `.github/copilot-instructions.md` — GitHub Copilot (VS Code)
> - `.windsurfrules` — Windsurf
> - `.gemini/styleguide.md` — Google Gemini (Android Studio / IDX)
>
> When updating, edit this file first, then sync the copies.
